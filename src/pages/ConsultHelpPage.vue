<template>
  <main class="page consult-page">
    ...
    <section class="card">
      ...
      <p class="note">상담 접수는 24시간 가능하며, 근무 시간 내 순차적으로 답변 드립니다.</p>
    </section>
...
/* ───────── 다크(=black) 모드: SupportCenter.vue 톤과 동일 ─────────
   ✅ 포인트
   - 프로젝트는 data-theme="black" 만 사용
   - scoped에서 전역 셀렉터는 :global( … ) 로 감싼다
   - 필요한 값은 CSS 변수로 주입
────────────────────────────────────────────────────────── */
...
:global(html[data-theme="black"] .consult-page .contact-list .copy){
  background:#2b2f36 !important;   /* 진회색 */
  border-color:#3a3f47 !important;  /* 테두리 조금 밝게 */
  color:#cfd4dc !important;         /* 글씨 연한 회색 */
...
:global(html[data-theme="black"] .consult-page .q){
  color:#ff6a6a !important; /* 고객센터와 동일 강조색 */
}
:global(html[data-theme="black"] .consult-page .a){
  color:#21c36b !important; /* 고객센터와 동일 */
}
</style>
